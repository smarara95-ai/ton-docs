...
- التنفيذ: عقد ذكي [modern_jetton](https://github.com/EmelyanenkoK/modern_jetton/blob/master/contracts/op-codes.func)
  <div class="text--center">
    <ThemedImage
...
- التنفيذ: عقد ذكي [minter-contract](https://github.com/ton-blockchain/minter-contract/blob/main/contracts/imports/op-codes.fc)
  <div class="text--center">
    <ThemedImage
...
## إثبات ملكية SBT للعقد

- التنفيذ: عقد ذكي [nft_contract](https://github.com/getgems-io/nft-contracts/blob/main/packages/contracts/sources/op-codes.fc)
  <div class="text--center">
    <ThemedImage
...
:::info
غير محدد بواسطة معيار NFT في /ton-blockchain/token-contract
:::
...
## تدمير SBT بواسطة المستخدم

- التنفيذ: عقد ذكي [nft_contracts](https://github.com/getgems-io/nft-contracts/blob/main/packages/contracts/sources/op-codes.fc)
  <div class="text--center">
    <ThemedImage
